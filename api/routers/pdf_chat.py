...
import uuid
import os
import qdrant_client as qc_module # Import module to check version
...
# --- DEBUG: Print the actual version running on Vercel ---
print(f"✅ QDRANT CLIENT VERSION: {qc_module.__version__}")
# ---------------------------------------------------------
...
async def upload_pdf(
    ...
    try:
        ...
        # Specific Model: gemini-embedding-001
...
async def chat(request: ChatRequest):
    try:
        ...
        # --- HYBRID SEARCH (Works on OLD and NEW versions) ---
